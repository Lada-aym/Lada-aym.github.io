/* ==========================================================================
   Поиск по сайту / руководству GAZelle Next
...
(function () {
  ...
  const MIN_QUERY = 2;
  const HISTORY_KEY = "gazelleNextSearchHistory";
    ...
    overlay.innerHTML = `
      <section class="os-search-modal" role="dialog" aria-modal="true" aria-labelledby="osSearchTitle">
        <div class="os-search-head">
          <div class="os-search-title" id="osSearchTitle">Поиск по сайту GAZelle Next</div>
        ...
        <div class="os-search-box">
          <div class="os-search-input-row">
            <input class="os-search-input" type="search" placeholder="Введите запрос: предохранители, давление шин, ЭРА-ГЛОНАСС…" autocomplete="off" />
