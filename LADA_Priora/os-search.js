/* ==========================================================================
   Поиск по сайту / руководству LADA Priora
...
(function () {
  ...
  const MIN_QUERY = 2;
  const HISTORY_KEY = "ladaPrioraSearchHistory";
    ...
    overlay.innerHTML = `
      <div class="os-search-modal" role="dialog" aria-modal="true" aria-label="Поиск по руководству">
        <div class="os-search-head">
          <span class="os-search-title">Поиск по руководству LADA Priora</span>
  ...
  function openSearch() {
    ...
    if (!resultsEl.innerHTML) {
      resultsEl.innerHTML = `<div class="os-search-empty">Поиск по ${getSections().length} разделам руководства LADA Priora. Клавиша «/» — быстрый вызов поиска.</div>`;
    }
