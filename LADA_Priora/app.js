/* ==========================================================================
   LADA Priora — руководство по эксплуатации (app.js)
...
const LS_FAV = "ladaPrioraFavorites";
const LS_THEME = "ladaPrioraTheme";
...
function renderStatus(items) {
  ...
  statusEl.textContent = `Все разделы руководства LADA Priora — всего ${total}.`;
}
