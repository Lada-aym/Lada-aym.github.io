/* ==========================================================================
   LADA Kalina — руководство по эксплуатации (app.js)
...
const LS_FAV = "ladaKalinaFavorites";
const LS_THEME = "ladaKalinaTheme";
...
function renderStatus(items) {
  ...
  statusEl.textContent = `Все разделы руководства LADA Kalina — всего ${total}.`;
}
