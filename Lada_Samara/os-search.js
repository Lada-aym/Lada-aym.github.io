/* ==========================================================================
   Поиск по сайту / руководству LADA Samara
...
(function () {
  ...
  const MIN_QUERY = 2;
  const HISTORY_KEY = "ladaSamaraSearchHistory";
    ...
    overlay.innerHTML = `
      <div class="os-search-modal" role="dialog" aria-modal="true" aria-label="Поиск по руководству">
        <div class="os-search-head">
          <span class="os-search-title">Поиск по руководству LADA Samara</span>
  ...
  function openSearch() {
    ...
    if (!resultsEl.innerHTML) {
      resultsEl.innerHTML = `<div class="os-search-empty">Поиск по ${getSections().length} разделам руководства LADA Samara. Клавиша «/» — быстрый вызов поиска.</div>`;
    }
