// LADA Granta — руководство по эксплуатации
...
const CACHE_VERSION = "v13-2026-07-20";
...
self.addEventListener("fetch", event => {
  ...
  // Это исправляет ситуацию, когда старые app.js/data.js/styles.css продолжали
  // отдаваться из Service Worker.
